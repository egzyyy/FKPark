...
if(isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM staff WHERE staffEmail=? AND staffPassword=?";
...
<div class="center-container">
    ...
    <div>
        <div class="login-container">
            <h1 class="login-title">UNIT KESELAMATAN STAFF LOGIN</h1>
            <?php
            if ($error != "") {
            ...
            <form method="post" action="">
                ...
                <div class="form-group text-center">
                    <a href="../admin/admin-login.php">Admin Login</a> | <a href="../student/student-login.php">Student Login</a>
                </div>
            </form>
        </div>
    </div>
